...
def load_predictions():
    df_predictions = pd.read_csv("../src/BERT_predictions.csv")  # Asegúrate de que el archivo esté en el mismo directorio
...
menu_option = st.sidebar.radio("Selecciona una sección:", ["Evaluación de Resúmenes", "Desempeño de los Modelos", "Análisis de Resúmenes"])
